...
-> "input.txt" and "google_CRED.txt" are the input file for CRED approach, generated in current folder.

-> ` GOOGLE_ORG.txt` is the raw data that is sliced into `google.txt`
